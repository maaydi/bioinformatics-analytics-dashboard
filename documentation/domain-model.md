...
-- Filter by GO aspect
CREATE INDEX idx_pgt_aspect ON protein_go_term (go_term_id)
    INCLUDE (protein_id);
```
...
REFRESH MATERIALIZED VIEW CONCURRENTLY mv_length_histogram;
REFRESH MATERIALIZED VIEW CONCURRENTLY mv_organism_counts;
REFRESH MATERIALIZED VIEW CONCURRENTLY mv_reviewed_ratio;
REFRESH MATERIALIZED VIEW CONCURRENTLY mv_evidence_distribution;
