...
| `OPS-001`       | Audit log + health/readiness + rate limiting + pagination cap                | `in-progress` |
...
| 12    | `OPS-001`       | `in-progress` | Hardening after core features are in place                   | Better reliability: health probes, throttling, auditability, safe page-size limits |
