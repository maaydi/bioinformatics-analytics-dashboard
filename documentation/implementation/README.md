...
| `FILTER-001`    | Saved filter feature (backend + frontend)                                    | `in-progress` |
...
| 9     | `FILTER-001`    | `in-progress` | Saved work is useful once filters/table are operational      | Users can save, reload, and delete personal filter presets                         |
