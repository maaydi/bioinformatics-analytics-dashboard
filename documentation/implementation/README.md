...
| `DASH-001`      | Dashboard page (KPI cards + charts)                                          | `in-progress` |
...
| 8     | `DASH-001`      | `in-progress` | UI layer on top of analytics endpoints                       | Users see dashboard KPI cards and charts with fast load times                      |
