...
| `GENE-003`      | GenesTable AG Grid component                                                 | `in-progress` |
...
| 5     | `GENE-003`      | `in-progress` | Table view consumes filters and list/search APIs             | Users can browse, sort, paginate, and open gene rows                               |
