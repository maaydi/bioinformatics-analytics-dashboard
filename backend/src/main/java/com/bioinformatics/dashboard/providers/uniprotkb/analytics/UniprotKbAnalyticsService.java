package com.bioinformatics.dashboard.providers.uniprotkb.analytics;
...
@Slf4j
public class UniprotKbAnalyticsService extends AbstractUniprotKbProvider implements AnalyticsService {
