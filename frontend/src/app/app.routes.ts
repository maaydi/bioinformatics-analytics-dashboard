  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'genes',
        loadComponent: () =>
          import('./features/genes/genes-page/genes-page.component').then(m => m.GenesPageComponent),
      },
      {
        path: 'genes/:id',
        loadComponent: () =>
      ...
      },
      {
        path: 'saved-filters',
        loadComponent: () =>
          import('./features/saved-filters/saved-filters.component').then(m => m.SavedFiltersComponent),
      },
      {
        path: 'admin/import',
        canActivate: [adminGuard],
        loadComponent: () =>
          import('./features/import-admin/import-admin.component').then(m => m.ImportAdminComponent),
      },
    ],
  },
  { path: '**', redirectTo: '' },
